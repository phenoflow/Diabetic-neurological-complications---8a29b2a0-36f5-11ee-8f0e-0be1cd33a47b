...
(async () => {
  ...
  await fs.writeFile("diabetic-neurological-complications-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("diabetic-neurological-complications-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
